...
gulp.task('copy:images', function (done) {
    gulp.src(['mview/images/**/*']).pipe(gulp.dest('dist/images')).on('end', done);
});

//压缩合并css, css中既有自己写的.less, 也有引入第三方库的.css
gulp.task('lessmin', function (done) {
    gulp.src(['mview/css/main.less', 'mview/css/*.css'])
        .pipe(less())
...
gulp.task('watch', function (done) {
    gulp.watch('mview/**/*', ['lessmin', 'build-js', 'fileinclude'])
        .on('end', done);
});
